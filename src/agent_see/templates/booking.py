...
def get_services_template(source_url: str = "") -> Capability:
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="id", field_type=ParameterType.STRING, description="Service ID"),
                ReturnField(name="name", field_type=ParameterType.STRING, description="Service name"),
                ReturnField(name="description", field_type=ParameterType.STRING, description="Service description"),
                ReturnField(name="price", field_type=ParameterType.NUMBER, description="Service price"),
                ReturnField(name="currency", field_type=ParameterType.STRING, description="Currency code"),
                ReturnField(name="duration_minutes", field_type=ParameterType.INTEGER, description="Service duration"),
                ReturnField(name="category", field_type=ParameterType.STRING, description="Service category"),
            ],
            is_array=True,
...
def check_availability_template(source_url: str = "") -> Capability:
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="service_id", field_type=ParameterType.STRING, description="Service ID"),
                ReturnField(name="available_slots", field_type=ParameterType.ARRAY, description="Available time slots"),
                ReturnField(name="next_available", field_type=ParameterType.STRING, description="Next available date/time"),
            ],
            is_array=False,
        ),
        side_effects=[],
...
def book_appointment_template(source_url: str = "") -> Capability:
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="booking_id", field_type=ParameterType.STRING, description="Booking confirmation ID"),
                ReturnField(name="status", field_type=ParameterType.STRING, description="Booking status"),
                ReturnField(name="service_name", field_type=ParameterType.STRING, description="Booked service name"),
                ReturnField(name="datetime", field_type=ParameterType.STRING, description="Confirmed date/time"),
                ReturnField(name="confirmation_url", field_type=ParameterType.STRING, description="Confirmation page URL"),
            ],
            is_array=False,
        ),
...
def get_booking_status_template(source_url: str = "") -> Capability:
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="booking_id", field_type=ParameterType.STRING, description="Booking ID"),
                ReturnField(name="status", field_type=ParameterType.STRING, description="Current status"),
                ReturnField(name="service_name", field_type=ParameterType.STRING, description="Service name"),
                ReturnField(name="datetime", field_type=ParameterType.STRING, description="Appointment date/time"),
                ReturnField(name="can_cancel", field_type=ParameterType.BOOLEAN, description="Whether booking can be cancelled"),
                ReturnField(name="can_reschedule", field_type=ParameterType.BOOLEAN, description="Whether booking can be rescheduled"),
            ],
            is_array=False,
        ),
        side_effects=[],
...
def cancel_booking_template(source_url: str = "") -> Capability:
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="booking_id", field_type=ParameterType.STRING, description="Booking ID"),
                ReturnField(name="status", field_type=ParameterType.STRING, description="Updated status"),
                ReturnField(name="refund_amount", field_type=ParameterType.NUMBER, description="Refund amount if applicable", nullable=True),
            ],
            is_array=False,
        ),
...
def get_business_info_template(source_url: str = "") -> Capability:
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="name", field_type=ParameterType.STRING, description="Business name"),
                ReturnField(name="address", field_type=ParameterType.STRING, description="Physical address"),
                ReturnField(name="phone", field_type=ParameterType.STRING, description="Phone number"),
                ReturnField(name="email", field_type=ParameterType.STRING, description="Contact email"),
                ReturnField(name="website", field_type=ParameterType.STRING, description="Website URL"),
                ReturnField(name="hours", field_type=ParameterType.OBJECT, description="Operating hours by day"),
                ReturnField(name="service_area", field_type=ParameterType.STRING, description="Geographic service area"),
                ReturnField(name="categories", field_type=ParameterType.ARRAY, description="Business categories/tags"),
            ],
            is_array=False,
        ),
        side_effects=[],
...
def request_quote_template(source_url: str = "") -> Capability:
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="quote_id", field_type=ParameterType.STRING, description="Quote request ID"),
                ReturnField(name="status", field_type=ParameterType.STRING, description="Quote request status"),
                ReturnField(name="estimated_response_hours", field_type=ParameterType.INTEGER, description="Expected response time in hours"),
            ],
            is_array=False,
        ),
...
def send_message_template(source_url: str = "") -> Capability:
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="message_id", field_type=ParameterType.STRING, description="Message ID"),
                ReturnField(name="status", field_type=ParameterType.STRING, description="Delivery status"),
            ],
            is_array=False,
        ),
