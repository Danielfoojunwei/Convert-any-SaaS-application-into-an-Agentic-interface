...
def list_products_template(source_url: str = "") -> Capability:
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="id", field_type="string", description="Product ID"),
                ReturnField(name="name", field_type="string", description="Product name"),
                ReturnField(name="price", field_type="number", description="Price"),
                ReturnField(name="currency", field_type="string", description="Currency code"),
                ReturnField(name="image_url", field_type="string", description="Product image URL"),
                ReturnField(name="in_stock", field_type="boolean", description="Whether product is in stock"),
            ],
            is_array=True,
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="id", field_type="string", description="Product ID"),
                ReturnField(name="name", field_type="string", description="Product name"),
                ReturnField(name="description", field_type="string", description="Full description"),
                ReturnField(name="price", field_type="number", description="Price"),
                ReturnField(name="currency", field_type="string", description="Currency code"),
                ReturnField(name="variants", field_type="array", description="Product variants (size, color, etc.)"),
                ReturnField(name="images", field_type="array", description="Product image URLs"),
                ReturnField(name="in_stock", field_type="boolean", description="Whether product is in stock"),
                ReturnField(name="category", field_type="string", description="Product category"),
            ],
            is_array=False,
...
def check_inventory_template(source_url: str = "") -> Capability:
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="product_id", field_type="string", description="Product ID"),
                ReturnField(name="in_stock", field_type="boolean", description="Whether in stock"),
                ReturnField(name="quantity", field_type="integer", description="Available quantity"),
                ReturnField(name="restock_date", field_type="string", description="Expected restock date", nullable=True),
            ],
            is_array=False,
        ),
        side_effects=[],
...
def add_to_cart_template(source_url: str = "") -> Capability:
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="cart_id", field_type="string", description="Cart session ID"),
                ReturnField(name="item_count", field_type="integer", description="Total items in cart"),
                ReturnField(name="subtotal", field_type="number", description="Cart subtotal"),
            ],
            is_array=False,
        ),
...
def get_cart_template(source_url: str = "") -> Capability:
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="cart_id", field_type="string", description="Cart session ID"),
                ReturnField(name="items", field_type="array", description="Cart items with product details"),
                ReturnField(name="item_count", field_type="integer", description="Total items"),
                ReturnField(name="subtotal", field_type="number", description="Subtotal before shipping/tax"),
                ReturnField(name="currency", field_type="string", description="Currency code"),
            ],
            is_array=False,
        ),
...
def remove_from_cart_template(source_url: str = "") -> Capability:
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="cart_id", field_type="string", description="Cart session ID"),
                ReturnField(name="item_count", field_type="integer", description="Remaining items"),
                ReturnField(name="subtotal", field_type="number", description="Updated subtotal"),
            ],
            is_array=False,
        ),
        side_effects=["modifies_cart"],
...
def apply_coupon_template(source_url: str = "") -> Capability:
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="applied", field_type="boolean", description="Whether the code was accepted"),
                ReturnField(name="discount_amount", field_type="number", description="Discount amount"),
                ReturnField(name="new_subtotal", field_type="number", description="Cart subtotal after discount"),
                ReturnField(name="message", field_type="string", description="Coupon status message"),
            ],
            is_array=False,
        ),
        side_effects=["modifies_cart"],
...
def calculate_shipping_template(source_url: str = "") -> Capability:
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="options", field_type="array", description="Available shipping options"),
                ReturnField(name="cheapest_option", field_type="object", description="Lowest cost option"),
                ReturnField(name="fastest_option", field_type="object", description="Fastest delivery option"),
            ],
            is_array=False,
        ),
        side_effects=[],
...
def submit_checkout_template(source_url: str = "") -> Capability:
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="checkout_id", field_type="string", description="Checkout session ID"),
                ReturnField(name="payment_url", field_type="string", description="URL for human to confirm payment"),
                ReturnField(name="total", field_type="number", description="Order total including shipping/tax"),
                ReturnField(name="currency", field_type="string", description="Currency code"),
                ReturnField(name="expires_at", field_type="string", description="When this checkout session expires"),
            ],
            is_array=False,
        ),
...
def get_order_status_template(source_url: str = "") -> Capability:
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="order_id", field_type="string", description="Order ID"),
                ReturnField(name="status", field_type="string", description="Order status"),
                ReturnField(name="tracking_number", field_type="string", description="Shipping tracking number", nullable=True),
                ReturnField(name="tracking_url", field_type="string", description="Tracking URL", nullable=True),
                ReturnField(name="estimated_delivery", field_type="string", description="Estimated delivery date", nullable=True),
                ReturnField(name="items", field_type="array", description="Ordered items"),
                ReturnField(name="total", field_type="number", description="Order total"),
            ],
            is_array=False,
        ),
        side_effects=[],
...
def initiate_return_template(source_url: str = "") -> Capability:
    ...
    return Capability(
        ...
        returns=ReturnSchema(
            fields=[
                ReturnField(name="return_id", field_type="string", description="Return request ID"),
                ReturnField(name="status", field_type="string", description="Return request status"),
                ReturnField(name="return_label_url", field_type="string", description="Return shipping label URL", nullable=True),
                ReturnField(name="refund_amount", field_type="number", description="Expected refund amount"),
            ],
            is_array=False,
        ),
